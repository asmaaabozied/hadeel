            ...
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group text-black dark:text-white"
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="pl-1">{{ __('messages.Dashboard') }}</span>
                    </div>
                </a>
                <ul x-cloak x-show="activeMenu === 'dashboard'" x-collapse
                    class="sub-menu flex flex-col gap-1 text-black dark:text-white/80">
                    <li>
                        <a href="{{ route('admins.index') }}">{{ __('messages.Admins') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('groups.index') }}">{{ __('messages.Groups') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('weekly_deportations.index') }}">{{ __('messages.Weekly Deportations') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('general_settings.edit') }}">{{ __('messages.General Settings') }}</a>
                    </li>
                    <li>
                        <a
                            href="{{ route('admin.deportation_rules.index') }}">{{ __('messages.Deportation Rules') }}</a>
                    </li>
                </ul>
